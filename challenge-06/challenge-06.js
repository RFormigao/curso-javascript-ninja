...
desafio.
*/
var teams = ["Corinthians", "Audax", "Santos", "São Paulo", "Palmeiras"];
...
function convertToHex(color) {
  switch (color) {
    ...
    case "preto":
      ...
      break;
    case "amarelo":
      console.log("O hexadecimal para a cor " + color + " é #C3E900.");    
      break;
    case "azul":
      console.log("O hexadecimal para a cor " + color + " é #0200FF.");    
      break;
    default:

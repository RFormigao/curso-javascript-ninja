(function () {
  ...
  */
  ...
  console.log('Ira mostrar a segunda frase, pois quando compararmos o objeto {number: 2} ' +
              'com o numberObjects ele ira criar outro objeto na memoria e por isso não ira ' +
              'encontrar, uma solução seria passar o primeiro objeto como referencia.');

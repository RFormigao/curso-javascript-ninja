(function () {
  ...
  */
  ...
  var fullName = 'jaque-paschoal-gomes-zzz';
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['Abel','Robson', 'Gabriel', 'Junior', 'Luan', 'Jonathan'];
  
 var listFriends = friends.reduce(function (acumulado, item, index) {
